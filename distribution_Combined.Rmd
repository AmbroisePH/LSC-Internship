---
title: "Distribution des contextes des phonemes, combiné ou non"
...
dist <- read.csv("data/data_cleaned/Buckeye_dictio/GetStat2_both.csv", header=F)
dist_comb <- read.csv("data/data_cleaned/Buckeye_dictio/GetStat2_combined.csv", header=F)
