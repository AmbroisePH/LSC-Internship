# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 17:38:42 2016
...
#                         pickle.dump(classifier.logRegressionLayer, f)
                    ...
                    SavedModel_name = ('BestModelEmb_%.2f_%i_%i.pkl' % (learning_rate, n_epochs, batch_size))
...
if __name__ == '__main__':
    ...
    results = []
#    learningrate=0.03
    for nepochs in range (2000,3500, 500):    
        for learningrate in numpy.arange(0.04, 0.07, 0.01):     
            for batchsize in range (75,150,25):
