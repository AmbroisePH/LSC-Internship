# -*- coding: utf-8 -*-
"""
Created on Mon Jul 25 19:40:33 2016

@author: ambroise

GOAL: Phone_Emb4 gets phone from the TWO previouses one AND the TWO next ones. Order deos matter (concatanation)
...
#            
    ...
    def shared_dataset(data_xy, borrow=True):
            ...
            """
            data_x_left, data_x_right, data_x_left2, data_x_right2, data_y = data_xy
            ...
            return shared_x_left, shared_x_right, shared_x_left2, shared_x_right2, T.cast(shared_y, 'int32')
    
    train_set_x_left, train_set_x_right, train_set_x_left2, train_set_x_right2, train_set_y = shared_dataset(train_set)
    valid_set_x_left, valid_set_x_right, valid_set_x_left2, valid_set_x_right2, valid_set_y = shared_dataset(valid_set)
    test_set_x_left, test_set_x_right, test_set_x_left2, test_set_x_right2, test_set_y = shared_dataset(test_set)
...
#    print(test_set_y.eval().shape)
#    
    rval = [(train_set_x_left, train_set_x_right, train_set_x_left2, train_set_x_right2, train_set_y), 
            (valid_set_x_left, valid_set_x_right, valid_set_x_left2, valid_set_x_right2, valid_set_y),
              (test_set_x_left, test_set_x_right, test_set_x_left2, test_set_x_right2, test_set_y)]
    return rval
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.logRegressionLayer = LogisticRegression(
            ...
            n_in_LR=4*n_hidden,  # 2 car concaténation
            n_out=n_out
        )
        ...
        self.params = self.hiddenLayer_left.params + self.logRegressionLayer.params
        # end-snippet-3
...
def test_mlp(pathname,learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    train_set_x_left, train_set_x_right, train_set_x_left2, train_set_x_right2, train_set_y = datasets[0]
    valid_set_x_left, valid_set_x_right, valid_set_x_left2, valid_set_x_right2, valid_set_y = datasets[1]
    test_set_x_left, test_set_x_right, test_set_x_left2, test_set_x_right2, test_set_y = datasets[2]
#
#    print(train_set_x_left.eval().shape)
#    print(train_set_y.eval().shape)
#    print(valid_set_x_left.eval().shape)
...
#    print(test_set_y.eval().shape)
    ...
    classifier = MLP(
        rng=rng,
        input=(x_left, x_right, x_left2, x_right2),
        n_in=n_in,
        n_hidden=n_hidden,
        n_out=n_in
    )
...
#                         pickle.dump(classifier.logRegressionLayer, f)
                    os.chdir("/home/ambroise/Documents/LSC-Internship/results/Phone_Emb7/#_Real")     
                    
                    SavedModel_name = ('BestModelEmb7_%.2f_%i_%i_%i.pkl' % (learning_rate, n_epochs, batch_size, n_hidden))
...
if __name__ == '__main__':
    ...
    pathname = "/home/ambroise/Documents/LSC-Internship/data/data_cleaned/Buckeye_#_real"
    results = []
#    learningrate=0.03
    for nepochs in range (3000,3500, 500):    
        learningrate = 0.09    
        for batchsize in range (75,100,25):
            for n_hidden in range (30,35,5):
